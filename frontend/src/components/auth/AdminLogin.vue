...
<template>
  <el-form ref="formRef" :model="form" :rules="rules" class="mt-8 admin-login-form" label-position="top" status-icon>
    <el-form-item label="管理员账号 (手机号)" prop="phone">
      <el-input v-model="form.phone" placeholder="请输入管理员手机号" inputmode="numeric" autocomplete="tel" />
    </el-form-item>
    
    <el-form-item label="管理员密码" prop="password">
      <el-input v-model="form.password" type="password" show-password placeholder="请输入管理员密码" autocomplete="current-password" />
    </el-form-item>
    ...
    <el-form-item label="验证码" prop="captcha">
      <div class="flex items-center w-full gap-3">
        ...
        >
          ...
          <div class="absolute inset-0 opacity-20 bg-[url('data:image/svg+xml;base64,PHN2ZyB4bWxucz0iaHR0cDovL3d3dy53My5vcmcvMjAwMC9zdmciIHdpZHRoPSI0IiBoZWlnaHQ9IjQiPgo8cmVjdCB3aWR0aD0iNCIgaGVpZ2h0PSI0IiBmaWxsPSIjZmZmIiAvPgo8cGF0aCBkPSJNMCAwTDIgMloiIHN0cm9rZT0iIzAwMCIgc3Ryb2tlLXdpZHRoPSIxIiAvPgo8L3N2Zz4=')]"></div>
        </div>
      </div>
    </el-form-item>
    
    <el-form-item class="mt-6">
      <el-button type="primary" class="w-full !bg-gray-800 !border-gray-800 hover:!bg-gray-700" :loading="loading" @click="submit">
        登录后台
      </el-button>
    </el-form-item>
  </el-form>
